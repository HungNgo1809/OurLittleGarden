...
public class PlantUI : MonoBehaviour
{
    ...
    public void displayTimeGrowth()
    {
        ...
        if (cropData.isHaveWater && state.cropstate != CropState.Harvestable) // dang co nuoc + chua thu hoach dc
        {
            ...
            float remainingTimeMinutes_float = timegrowthmax_int * state.seasonTimeExtend - timegrowth_int;

            remainingTimeMinutes = Mathf.RoundToInt(remainingTimeMinutes_float);
